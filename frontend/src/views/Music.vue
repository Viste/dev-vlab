  ...
  <div class="max-w-6xl mx-auto px-4 py-10">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      <div class="md:col-span-2 bento-card p-8">
        <p class="text-sm text-red-700 font-mono mb-2">music</p>
        <h1 class="text-3xl font-bold">Music &amp; Sound</h1>
        <p class="text-gray-400 mt-2">Releases, demos, and live radio streams.</p>
      </div>

      <div v-if="radio" class="bento-card p-6 flex flex-col justify-between border-red-800/20">
        <div>
          <div class="flex items-center gap-2 mb-2">
            <span class="w-2 h-2 rounded-full bg-red-700 animate-pulse"></span>
            <span class="text-sm font-semibold text-red-700">LIVE</span>
          </div>
      ...
      <div v-for="release in releases" :key="release.id" class="bento-card overflow-hidden">
        ...
        <div class="p-4">
          ...
          <a v-if="release.release_url" :href="release.release_url" target="_blank"
            class="inline-block mt-3 text-sm text-red-700 hover:underline">Listen &rarr;</a>
        </div>
      </div>
